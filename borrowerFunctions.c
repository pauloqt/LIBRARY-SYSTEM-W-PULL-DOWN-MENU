        ...
        if(locateTUP_ID(infoBorrower.TUP_ID)!=NULL){
            ...
            if(strcmp(rePass, infoBorrower.password)==0){
                    ...
                    gotoxy(55,21); printf("CONTACT NUMBER (Ex. 09123456789): ");
                        ...
                        gotoxy(55,24); printf("DO YOU WANT TO SUBMIT YOUR REGISTRATION? [1] YES [2] NO : ");
                        gotoxy(115,24);scanf("%d", &submit);
                        if(submit==1){
                            addBorrower();
                            saveInfoBorrower();
                            strcpy(loggedInID, infoBorrower.TUP_ID);
                            gotoxy(55,26); printf("YOUR ACCOUNT IS SUCCESSFULLY REGISTERED!");
                            gotoxy(55,27); system("pause");
                            return;
                        }
            }
            else{
                gotoxy(56,19); printf("PASSWORD DIDN'T MATCH");
                gotoxy(56,21);system("pause"); system("cls");
                goto PASS;
            }
        }
    }
...
BOOK *p;
    ...
    if(fp==NULL){
        ...
        while(1){
            ...
            strcpy(infoBorrower.contactNum, decrypt(infoBorrower.contactNum)); strcpy(infoBorrower.email, decrypt(infoBorrower.email)); strcpy(infoBorrower.name, decrypt(infoBorrower.name));
...
//The searchBorrower() function prompts the user to enter a search a string, and then searches the linked list for any borrower whose info matches the search string. It displays information about any matching books.
void searchBorrower(){
BORROWER *p;
char toSearch[51];
...
int updateInt;
    ...
    gotoxy(30,9);printf("\033[31m ___________________________________________________________________________________________________________________");
    gotoxy(30,10);printf("|   _                                                                                                               |");
    gotoxy(30,11);printf("|  (_)  ENTER YOUR TUP ID:                                                                                          |");
    gotoxy(30,12);printf("|    \\                                                                                                              |");
    gotoxy(30,13);printf("|___________________________________________________________________________________________________________________|");
    printf("\033[0m");

    gotoxy(61,11);scanf("%s", TUP_ID);
    p = locateTUP_ID(TUP_ID);
